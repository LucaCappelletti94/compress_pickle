...
htmlhelp_basename = "compress_pickledoc"
...
latex_documents = [
    (
        master_doc,
        "compress_pickle.tex",
        "compress\\_pickle Documentation",
        "Luciano Paz",
        "manual",
    ),
]
...
man_pages = [
    (master_doc, "compress_pickle", "compress_pickle Documentation", [author], 1)
]
...
def linkcode_resolve(domain, info):
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(compress_pickle.__file__))
    ...
    tag = "master"
    return "https://github.com/lucianopaz/compress_pickle/blob/{}/{}".format(
        tag, filename
    )
